...
Draft: *"I'm a full stack developer in Coimbatore, three years into building
...
stays fast as features pile up."*
...
*Not chosen, kept for reference.* **Palette B — Forest & Bone:** paper `#FAF9F5`, ink `#0F2A22` (14.50:1),
muted `#5C6B63` (5.33:1), accent `#D97706` (3.02:1), accent-text `#B45309`
(4.77:1).

*Not chosen, kept for reference.* **Palette C — Ink & Indigo:** paper `#FCFCFD`, ink `#0F1222` (18.13:1),
...
Nothing *resizes* at a breakpoint — type and spacing scale continuously with
...
2. **Container queries** (`@container`) on cards, so a card responds to *its
   own slot*, not the viewport. A project card then works in a 1-, 2- or
